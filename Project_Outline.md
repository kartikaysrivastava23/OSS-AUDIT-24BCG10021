...
* **Name:** Kartikay Srivastava
* **Registration Number:** 24BCG10021
* **Slot:** E22
* **Date:** 31/03/2026
...
* **Situation in 1996:**  Video streaming over networks was mostly restricted and controlled by proprietary systems.
* **Initial Development:** Students from École Centrale Paris aimed to stream live television across their campus network (VIA Centrale Réseaux).
* **Limitation Faced:** Tools like Windows Media Player wouldn't let them tweak the code to fit their needs. They had to build their own client and server.
